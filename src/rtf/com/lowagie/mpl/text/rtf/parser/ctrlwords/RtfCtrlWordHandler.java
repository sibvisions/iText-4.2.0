 ...
 */
package com.lowagie.mpl.text.rtf.parser.ctrlwords; 
...
public class RtfCtrlWordHandler implements Cloneable {
	 ...
	 * @see com.lowagie.mpl.text.rtf.parser.ctrlwords.RtfCtrlWordHandler#RtfCtrlWordHandler(RtfParser rtfParser, String ctrlWord, int defaultParameterValue, boolean passDefaultParameterValue, int ctrlWordType, String prefix, String suffix, String specialHandler)
	 * @since 2.0.8
	 */
