...
public class OcspClientBouncyCastle implements OcspClient {
     ...
     * @throws IOException
     */
    private static OCSPReq generateOCSPRequest(X509Certificate issuerCert, BigInteger serialNumber) throws OCSPException, CertificateEncodingException, OperatorCreationException, IOException {
        //Add provider BC
        ...
        egen.addExtension(OCSPObjectIdentifiers.id_pkix_ocsp_nonce, false, new DEROctetString(new DEROctetString(PdfEncryption.createDocumentId()).getEncoded()));

        gen.setRequestExtensions(egen.generate());
    ...
    /**
     * @return 	a byte array
     * @see com.lowagie.mpl.text.pdf.OcspClient#getEncoded()
     */
