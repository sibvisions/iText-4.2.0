...
import com.lowagie.mpl.text.exceptions.InvalidPdfException;
import com.lowagie.mpl.text.exceptions.UnsupportedPdfException;
...
public class PdfReader implements PdfViewerPreferences {
    ...
    private void readDecryptedDocObj() throws IOException {
        ...
        if (documentIDs != null) {
            ...
            strings.remove(o);
            s = o.toString();
            documentID = com.lowagie.mpl.text.DocWriter.getISOBytes(s);
        ...
        if (filter.equals(PdfName.STANDARD)) {
            ...
            uValue = com.lowagie.mpl.text.DocWriter.getISOBytes(s);
            s = enc.get(PdfName.O).toString();
            strings.remove(enc.get(PdfName.O));
            oValue = com.lowagie.mpl.text.DocWriter.getISOBytes(s);
