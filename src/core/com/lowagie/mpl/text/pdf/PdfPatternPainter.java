...
public final class PdfPatternPainter extends PdfTemplate {
    ...
    /**
     * @see com.lowagie.mpl.text.pdf.PdfContentByte#setGrayFill(float)
     */
    ...
    /**
     * @see com.lowagie.mpl.text.pdf.PdfContentByte#resetGrayFill()
     */
    ...
    /**
     * @see com.lowagie.mpl.text.pdf.PdfContentByte#setGrayStroke(float)
     */
    ...
    /**
     * @see com.lowagie.mpl.text.pdf.PdfContentByte#resetGrayStroke()
     */
    ...
    /**
     * @see com.lowagie.mpl.text.pdf.PdfContentByte#setRGBColorFillF(float, float, float)
     */
    ...
    /**
     * @see com.lowagie.mpl.text.pdf.PdfContentByte#resetRGBColorFill()
     */
    ...
    /**
     * @see com.lowagie.mpl.text.pdf.PdfContentByte#setRGBColorStrokeF(float, float, float)
     */
    ...
    /**
     * @see com.lowagie.mpl.text.pdf.PdfContentByte#resetRGBColorStroke()
     */
    ...
    /**
     * @see com.lowagie.mpl.text.pdf.PdfContentByte#setCMYKColorFillF(float, float, float, float)
     */
    ...
    /**
     * @see com.lowagie.mpl.text.pdf.PdfContentByte#resetCMYKColorFill()
     */
    ...
    /**
     * @see com.lowagie.mpl.text.pdf.PdfContentByte#setCMYKColorStrokeF(float, float, float, float)
     */
    ...
    /**
     * @see com.lowagie.mpl.text.pdf.PdfContentByte#resetCMYKColorStroke()
     */
    ...
    /**
     * @see com.lowagie.mpl.text.pdf.PdfContentByte#addImage(com.lowagie.mpl.text.Image, float, float, float, float, float, float)
     */
    ...
    /**
     * @see com.lowagie.mpl.text.pdf.PdfContentByte#setCMYKColorFill(int, int, int, int)
     */
    ...
    /**
     * @see com.lowagie.mpl.text.pdf.PdfContentByte#setCMYKColorStroke(int, int, int, int)
     */
    ...
    /**
     * @see com.lowagie.mpl.text.pdf.PdfContentByte#setRGBColorFill(int, int, int)
     */
    ...
    /**
     * @see com.lowagie.mpl.text.pdf.PdfContentByte#setRGBColorStroke(int, int, int)
     */
    ...
    /**
     * @see com.lowagie.mpl.text.pdf.PdfContentByte#setColorStroke(java.awt.Color)
     */
    ...
    /**
     * @see com.lowagie.mpl.text.pdf.PdfContentByte#setColorFill(java.awt.Color)
     */
    ...
    /**
     * @see com.lowagie.mpl.text.pdf.PdfContentByte#setColorFill(com.lowagie.mpl.text.pdf.PdfSpotColor, float)
     */
    ...
    /**
     * @see com.lowagie.mpl.text.pdf.PdfContentByte#setColorStroke(com.lowagie.mpl.text.pdf.PdfSpotColor, float)
     */
    ...
    /**
     * @see com.lowagie.mpl.text.pdf.PdfContentByte#setPatternFill(com.lowagie.mpl.text.pdf.PdfPatternPainter)
     */
    ...
    /**
     * @see com.lowagie.mpl.text.pdf.PdfContentByte#setPatternFill(com.lowagie.mpl.text.pdf.PdfPatternPainter, java.awt.Color, float)
     */
    ...
    /**
     * @see com.lowagie.mpl.text.pdf.PdfContentByte#setPatternStroke(com.lowagie.mpl.text.pdf.PdfPatternPainter, java.awt.Color, float)
     */
    ...
    /**
     * @see com.lowagie.mpl.text.pdf.PdfContentByte#setPatternStroke(com.lowagie.mpl.text.pdf.PdfPatternPainter)
     */
