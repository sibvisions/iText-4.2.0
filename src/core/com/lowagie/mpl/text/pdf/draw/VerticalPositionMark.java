...
package com.lowagie.mpl.text.pdf.draw;
...
public class VerticalPositionMark implements DrawInterface, Element {
	...
	/**
	 * @see com.lowagie.mpl.text.pdf.draw.DrawInterface#draw(com.lowagie.mpl.text.pdf.PdfContentByte, float, float, float, float, float)
	 */
    ...
    /**
     * @see com.lowagie.mpl.text.Element#process(com.lowagie.mpl.text.ElementListener)
     */
    ...
    /**
     * @see com.lowagie.mpl.text.Element#type()
     */
    public int type() {
    ...
    /**
     * @see com.lowagie.mpl.text.Element#getChunks()
     */
