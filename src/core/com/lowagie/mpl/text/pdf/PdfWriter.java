...
import com.lowagie.mpl.text.DocListener;
import com.lowagie.mpl.text.DocWriter;
import com.lowagie.mpl.text.Document;
import com.lowagie.mpl.text.DocumentException;
import com.lowagie.mpl.text.ExceptionConverter;
import com.lowagie.mpl.text.Image;
import com.lowagie.mpl.text.ImgJBIG2;
import com.lowagie.mpl.text.ImgWMF;
import com.lowagie.mpl.text.Rectangle;
import com.lowagie.mpl.text.Table;
import com.lowagie.mpl.text.error_messages.MessageLocalization;
import com.lowagie.mpl.text.pdf.collection.PdfCollection;
import com.lowagie.mpl.text.pdf.events.PdfPageEventForwarder;
import com.lowagie.mpl.text.pdf.interfaces.PdfAnnotations;
import com.lowagie.mpl.text.pdf.interfaces.PdfDocumentActions;
import com.lowagie.mpl.text.pdf.interfaces.PdfEncryptionSettings;
import com.lowagie.mpl.text.pdf.interfaces.PdfPageActions;
import com.lowagie.mpl.text.pdf.interfaces.PdfRunDirection;
import com.lowagie.mpl.text.pdf.interfaces.PdfVersion;
import com.lowagie.mpl.text.pdf.interfaces.PdfViewerPreferences;
import com.lowagie.mpl.text.pdf.interfaces.PdfXConformance;
import com.lowagie.mpl.text.pdf.internal.PdfVersionImp;
import com.lowagie.mpl.text.pdf.internal.PdfXConformanceImp;
import com.lowagie.mpl.text.xml.xmp.XmpWriter;
...
//	Open and Close methods + method that create the PDF
     ...
     * @see com.lowagie.mpl.text.DocWriter#open()
     */
    public void open() {
        super.open();
        try {
     ...
     * @see com.lowagie.mpl.text.DocWriter#close()
     */
    public void close() {
        if (open) {
...
//	[C2] PdfVersion interface
    ...
    /** @see com.lowagie.mpl.text.pdf.interfaces.PdfVersion#setPdfVersion(char) */
    public void setPdfVersion(char version) {
        pdf_version.setPdfVersion(version);
    }

    /** @see com.lowagie.mpl.text.pdf.interfaces.PdfVersion#setAtLeastPdfVersion(char) */
    public void setAtLeastPdfVersion(char version) {
    	pdf_version.setAtLeastPdfVersion(version);
    }

	/** @see com.lowagie.mpl.text.pdf.interfaces.PdfVersion#setPdfVersion(com.lowagie.mpl.text.pdf.PdfName) */
	public void setPdfVersion(PdfName version) {
		pdf_version.setPdfVersion(version);
	}

	/**
	 * @see com.lowagie.mpl.text.pdf.interfaces.PdfVersion#addDeveloperExtension(com.lowagie.mpl.text.pdf.PdfDeveloperExtension)
	 * @since	2.1.6
	 */
...
//  [C3] PdfViewerPreferences interface
    ...
    /** @see com.lowagie.mpl.text.pdf.interfaces.PdfViewerPreferences#setViewerPreferences(int) */
    public void setViewerPreferences(int preferences) {
        pdf.setViewerPreferences(preferences);
    }

    /** @see com.lowagie.mpl.text.pdf.interfaces.PdfViewerPreferences#addViewerPreference(com.lowagie.mpl.text.pdf.PdfName, com.lowagie.mpl.text.pdf.PdfObject) */
...
// [C6] Actions (open and additional)
    ...
    /** @see com.lowagie.mpl.text.pdf.interfaces.PdfDocumentActions#setOpenAction(java.lang.String) */
    public void setOpenAction(String name) {
         pdf.setOpenAction(name);
     }

    /** @see com.lowagie.mpl.text.pdf.interfaces.PdfDocumentActions#setOpenAction(com.lowagie.mpl.text.pdf.PdfAction) */
    public void setOpenAction(PdfAction action) {
         pdf.setOpenAction(action);
     }

    /** @see com.lowagie.mpl.text.pdf.interfaces.PdfDocumentActions#setAdditionalAction(com.lowagie.mpl.text.pdf.PdfName, com.lowagie.mpl.text.pdf.PdfAction) */
...
//  [C8] AcroForm
    ...
    /** @see com.lowagie.mpl.text.pdf.interfaces.PdfAnnotations#getAcroForm() */
    public PdfAcroForm getAcroForm() {
        return pdf.getAcroForm();
    }

    /** @see com.lowagie.mpl.text.pdf.interfaces.PdfAnnotations#addAnnotation(com.lowagie.mpl.text.pdf.PdfAnnotation) */
    ...
    /** @see com.lowagie.mpl.text.pdf.interfaces.PdfAnnotations#addCalculationOrder(com.lowagie.mpl.text.pdf.PdfFormField) */
    public void addCalculationOrder(PdfFormField annot) {
        pdf.addCalculationOrder(annot);
    }

    /** @see com.lowagie.mpl.text.pdf.interfaces.PdfAnnotations#setSigFlags(int) */
...
//  [C10] PDFX Conformance
    ...
    /** @see com.lowagie.mpl.text.pdf.interfaces.PdfXConformance#setPDFXConformance(int) */
    ...
    /** @see com.lowagie.mpl.text.pdf.interfaces.PdfXConformance#getPDFXConformance() */
    public int getPDFXConformance() {
        return pdfxConformance.getPDFXConformance();
    }

    /** @see com.lowagie.mpl.text.pdf.interfaces.PdfXConformance#isPdfX() */
...
//  [F1] PdfEncryptionSettings interface
    ...
    /** @see com.lowagie.mpl.text.pdf.interfaces.PdfEncryptionSettings#setEncryption(byte[], byte[], int, int) */
    ...
    /** @see com.lowagie.mpl.text.pdf.interfaces.PdfEncryptionSettings#setEncryption(java.security.cert.Certificate[], int[], int) */
...
//  [U3] page actions (open and close)
    ...
    /** @see com.lowagie.mpl.text.pdf.interfaces.PdfPageActions#setPageAction(com.lowagie.mpl.text.pdf.PdfName, com.lowagie.mpl.text.pdf.PdfAction) */
    ...
    /** @see com.lowagie.mpl.text.pdf.interfaces.PdfPageActions#setDuration(int) */
    public void setDuration(int seconds) {
         pdf.setDuration(seconds);
     }

    /** @see com.lowagie.mpl.text.pdf.interfaces.PdfPageActions#setTransition(com.lowagie.mpl.text.pdf.PdfTransition) */
