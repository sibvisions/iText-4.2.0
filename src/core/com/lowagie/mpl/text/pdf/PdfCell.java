 ...
 * <P>
 * When using variable borders ({@link com.lowagie.mpl.text.Rectangle#isUseVariableBorders isUseVariableBorders()} == true),
 ...
 * cells.
 *
 * @see		com.lowagie.mpl.text.Rectangle
 * @see		com.lowagie.mpl.text.Cell
 * @see		PdfLine
 * @see		PdfTable
 */
...
public class PdfCell extends Rectangle {
     ...
     * @param side the side to check.  One of the side constants in {@link com.lowagie.mpl.text.Rectangle}
